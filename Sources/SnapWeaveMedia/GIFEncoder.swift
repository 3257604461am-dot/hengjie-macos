...
public enum GIFTemporaryFiles {
    public static var directory: URL {
        FileManager.default.temporaryDirectory.appendingPathComponent("com.wonderlab.snapweave/gif", isDirectory: true)
    }
    ...
    public static func cleanupStaleFiles() {
        for candidate in [directory, legacyDirectory] {
            guard let urls = try? FileManager.default.contentsOfDirectory(at: candidate, includingPropertiesForKeys: nil) else { continue }
